...
**Active Feature:** None — BUG-PROD-004 merged 2026-04-12. Next up: **F-UX-B** (Spanish portion terms — branch `feature/F-UX-B-spanish-portion-terms` is paused at commit `06fc653` with analysis committed; resume with rebase on develop then enter spec phase with Q1–Q7 decisions already locked in per context-recovery prompt).
