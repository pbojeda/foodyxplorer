...
**Active Feature:** F093 — Web Assistant: Landing Integration + Analytics | Step 0/6 (Spec) | Standard | Branch: pending
...
| F093 | Web Assistant: Landing Integration + Analytics | frontend | in-progress | 0/6 | Standard. CTA from landing → /hablar. Analytics events. Visual coherence with landing design system |
