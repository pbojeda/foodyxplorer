...
**Active Feature:** F092 — Web Assistant: Plate Photo Upload | Step 4/6 (Finalize) | Standard | Branch: feature/F092-web-assistant-plate-photo-upload
...
| F092 | Web Assistant: Plate Photo Upload | frontend | in-progress | 4/6 | Standard. Photo → existing /analyze/menu pipeline → results in UI. Reuses existing Vision API infrastructure |
