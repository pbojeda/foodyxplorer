...
| F033 | L4 Prompt Enhancement (explicit amounts + portion_multiplier) | backend | in-progress | 4/6 | Simple. Quick win. Prompt fix for Strategy B. portion_multiplier pattern (ADR-009) |
