...
**Active Feature:** F054 — Context State Isolation & NL Footer Consistency
**Step:** 4/6 (Finalize)
**Branch:** `feature/F054-context-state-nl-footer`
**Complexity:** Simple
**Context:** I3: update manual TTL description (Option B). I4: add "Contexto activo" footer to NL handler.
...
| F054 | Context State Isolation & NL Footer Consistency | bot | in-progress | 4/6 | Bug. I3: shared Redis key TTL refreshed by unrelated writes. I4: NL handler missing "Contexto activo" footer. From audit I3+I4 (Codex) |
