...
**Active Feature:** BUG-PROD-006 — F085+F-UX-B conversation wiring fix. Step 5/6 (Ready for Merge). Branch: `bug/BUG-PROD-006-f085-fux-b-conversation-wiring`. All 5 commits on branch. code-review-specialist: APPROVE WITH MINOR CHANGES (no blockers; comparison/menu paths follow-up noted). qa-engineer: no new blockers. Merge Checklist Evidence filled. Awaiting user merge approval.
...
8. **BUG-PROD-006** — F085+F-UX-B conversation wiring (M1) — **PENDING REVIEW+MERGE** (Steps 0-4 done, 4 commits, 12/12 GREEN + 3270 unit tests)
