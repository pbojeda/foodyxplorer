...
| F084 | Estimation with Uncertainty Ranges | backend | in-progress | 5/6 | Simple. PR #76. 26 tests (2 files). enrichWithUncertainty() helper, ±5%-±30% matrix. Code review: APPROVED |
