...
| F055 | Inline Keyboard Stale-Button Mitigation + Callback Logging | bot | in-progress | 1/6 | Bug (low). Stale-button race with multiple photos/searches + unknown callback_data not logged. From audit I7+S6 (Codex, Claude) |
