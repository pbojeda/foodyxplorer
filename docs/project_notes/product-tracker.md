...
| F085 | Portion Sizing Matrix (Spanish portions) | backend | in-progress | 1/6 | Simple. Detect Spanish portion terms in query, enrich with gram ranges. enrichWithPortionSizing() DRY helper |
