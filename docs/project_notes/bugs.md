...
- **Feature**: F093 | **Found by**: QA review (edge-cases.f093.qa.test.tsx) | **Severity**: Low (test data bug, no production impact — `page.tsx` always passes base URL) | **Status**: Open
- **Exposed by**: `packages/landing/src/__tests__/edge-cases.f093.qa.test.tsx` — "REGRESSION: edge-cases.f093.test.tsx passes pre-UTM URL — exposes double-append bug"
