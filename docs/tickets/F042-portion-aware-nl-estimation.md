...
| 1. Mark all items | [x] | AC: 14/14, DoD: 6/6, Workflow: 0-5/6 |
| 2. Verify product tracker | [x] | Active Session: step 5/6 (Review), Features table: 5/6 |
| 3. Update key_facts.md | [x] | Updated: estimate route (portionMultiplier param + cache key), estimate schemas (portionMultiplier fields), NL handler (pipeline update), portionModifier (new entry) |
| 4. Update decisions.md | [x] | N/A — no new ADR needed |
| 5. Commit documentation | [x] | Commit: ff335ea |
