...
- [ ] Step 2: `backend-planner` executed, implementation plan filled in above, plan approved
- [ ] Step 3: `backend-developer` executed with TDD (unit tests first, then implementation, then integration test)
- [ ] Step 4: `production-code-validator` executed, quality gates pass
- [ ] Step 5: `code-review-specialist` executed; `qa-engineer` executed
