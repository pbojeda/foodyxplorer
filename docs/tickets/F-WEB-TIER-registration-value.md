...
**Status:** Done | **Branch:** feature/F-WEB-TIER-registration-value
...
| 1. Mark all items | [x] | AC: 34/37 (AC35–AC37 = operator post-deploy smokes, intentionally deferred); DoD: 7/7; Workflow: Steps 0–6 [x]. Status → Done (merged) |
