...
2. Update global spec files (`api-spec.yaml`, `ui-components.md`) and validation schemas if applicable
...
2. **Std/Cplx:** Follow `production-code-validator` instructions in `.gemini/agents/` — **do NOT skip**
