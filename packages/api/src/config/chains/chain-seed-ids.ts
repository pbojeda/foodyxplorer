...
export const CHAIN_SEED_IDS = {
  ...
  POPEYES_ES: {
    RESTAURANT_ID: '00000000-0000-0000-0006-000000000017',
    SOURCE_ID:     '00000000-0000-0000-0000-000000000018',
  },
  PAPA_JOHNS_ES: {
    RESTAURANT_ID: '00000000-0000-0000-0006-000000000018',
    SOURCE_ID:     '00000000-0000-0000-0000-000000000019',
  },
  PIZZA_HUT_ES: {
    RESTAURANT_ID: '00000000-0000-0000-0006-000000000019',
    SOURCE_ID:     '00000000-0000-0000-0000-000000000020',
  },
  STARBUCKS_ES: {
    RESTAURANT_ID: '00000000-0000-0000-0006-000000000020',
    SOURCE_ID:     '00000000-0000-0000-0000-000000000021',
  },
  TIM_HORTONS_ES: {
    RESTAURANT_ID: '00000000-0000-0000-0006-000000000021',
    SOURCE_ID:     '00000000-0000-0000-0000-000000000022',
  },
} as const;
