  ...
  it('structured mode — cookingState and cookingMethod passed to resolveAndApplyYield', async () => {
    ...
    mockResolveAndApplyYield.mockResolvedValue({
      result: {
        ...
        chainSlug: null,
        portionGrams: null,
        nutrients: { calories: 130, proteins: 2.5, carbohydrates: 28, sugars: 0, fats: 0.21, saturatedFats: 0.036, fiber: 0.46, salt: 0, sodium: 0.36, transFats: 0, cholesterol: 0, potassium: 41, monounsaturatedFats: 0.071, polyunsaturatedFats: 0.071, alcohol: 0, referenceBasis: 'per_100g' as const },
        confidenceLevel: 'high' as const,
        estimationMethod: 'official' as const,
        source: { id: FOOD_NUTRIENT_ROW.source_id, name: 'USDA', type: 'official' as const, url: null },
        similarityDistance: null,
